...
public class TestAnswerController : ControllerBase
{
    ...
    public TestAnswerController(ITestAnswerService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] TestAnswerRequest request)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(int id, [FromBody] TestAnswerUpdate update)
    {
