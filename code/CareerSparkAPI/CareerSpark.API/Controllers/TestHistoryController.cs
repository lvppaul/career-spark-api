...
public class TestHistoryController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] TestHistoryRequest request)
    {
    ...
    [Authorize(Roles = "Admin,Moderator,User")]
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(int id, [FromBody] TestHistoryUpdate update)
    {
