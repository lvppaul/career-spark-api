...
<body style='font-family: Arial, sans-serif; background-color:#f7f7f7; padding:20px;'>
    ...
    <div style='max-width:600px; margin:auto; background:white; padding:25px; border-radius:10px;
        ...
        <div style='text-align:center;'>
            <img src='https://res.cloudinary.com/dliirxsmo/image/upload/v1761800009/logo_dacig0.jpg'
                 alt='CareerSpark Logo' width='130' style='margin-bottom:15px;'/>
            <h2 style='color:#28a745;'>Thanh toán thành công!</h2>
        </div>

        <p>Xin chào <b>{userName}</b>,</p>
        <p>Cảm ơn bạn đã thanh toán đơn hàng thông qua <b>PayOS</b>. Dưới đây là thông tin đơn hàng của bạn:</p>
        ...
        <p style='color:#777; font-size:13px; margin-top:15px; text-align:center;'>
            Cảm ơn bạn đã tin tưởng CareerSpark!
        </p>
